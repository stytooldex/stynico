...
public class ItemApkAdapter extends BaseAdapter
{
    ...
    public ItemApkAdapter(Context context, ArrayList<ItemApk> alItemApl)
	{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
	{
        ...
        if (convertView == null)
		{
            ...
            holder.tvApkName = (TextView) convertView.findViewById(R.id.tvApkName);
            holder.tvApkVersion = (TextView) convertView.findViewById(R.id.tvApkVersion);
            holder.ivApkIcon = (ImageView) convertView.findViewById(R.id.ivApkIcon);
            holder.tvApkSize = (TextView) convertView.findViewById(R.id.tvApkSize);
            holder.tvApkRunning = (TextView) convertView.findViewById(R.id.tvApkRunning);
