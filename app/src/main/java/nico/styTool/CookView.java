...
public class CookView extends ImageView
{
    ...
    public CookView(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		setUp(context, attrs);
    }

    public CookView(Context context, AttributeSet attrs, int defStyleAttr)
	{
