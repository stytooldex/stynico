...
implements Parcelable
{
    ...
    static {
            ...
            public FolderChooserConfig createFromParcel(Parcel parcel)
	    {
                ...
                boolean bl3 = parcel.readByte() != 0 && bl2;
                folderChooserConfig.showHidden = bl3;
                boolean bl4 = parcel.readByte() != 0 && bl2;
                folderChooserConfig.mustBeWritable = bl4;
                boolean bl5 = parcel.readByte() != 0 && bl2;
                folderChooserConfig.expandSingularRoot = bl5;
