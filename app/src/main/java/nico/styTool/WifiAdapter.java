...
//将每2位16进制整数组装成一个字节 
    ...
    public void AddAll(List<WifiInfo> infos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.tvName = (TextView) convertView.findViewById(R.id.tv_wifi_name);
            holder.tvPass = (TextView) convertView.findViewById(R.id.tv_wifi_pass);
            holder.tvKey = (TextView) convertView.findViewById(R.id.tv_wifi_key);
