...
public class aa extends Thread
{
	...
	private cc gifFrame; // frames read from current file
	private int frameCount;

	private bb action = null;


	private byte[] gifData = null;


	public aa(byte[] data, bb act)
	{
		gifData = data;
		action = act;
	}

	public aa(InputStream is, bb act)
	{
		in = is;
		action = act;
	}
...
//	}
	...
	private void readImage()
	{
		...
		else
		{
			...
			f.nextFrame = new cc(image, delay);
		}
